...
body = swagger_client.TableNameBulkBody() # TableNameBulkBody |  (optional)
...
db_branch_name = swagger_client.DBBranchName() # DBBranchName | The DBBranchName matches the pattern `{db_name}:{branch_name}`. 
table_name = swagger_client.TableName() # TableName | The Table name
record_id = swagger_client.RecordID() # RecordID | The Record name
...
db_branch_name = swagger_client.DBBranchName() # DBBranchName | The DBBranchName matches the pattern `{db_name}:{branch_name}`. 
table_name = swagger_client.TableName() # TableName | The Table name
body = swagger_client.TableNameQueryBody() # TableNameQueryBody |  (optional)
...
api_instance = swagger_client.RecordsApi(swagger_client.ApiClient(configuration))
db_branch_name = swagger_client.DBBranchName() # DBBranchName | The DBBranchName matches the pattern `{db_name}:{branch_name}`. 
body = swagger_client.DbBranchNameSearchBody() # DbBranchNameSearchBody |  (optional)
